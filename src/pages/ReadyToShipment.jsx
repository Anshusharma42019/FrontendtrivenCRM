        ...
        <Modal title="Shipment Detail" onClose={() => setSelected(null)}>
          ...
          <div className="pt-4 flex gap-2">
            <button
              ...
              <svg className="w-4 h-4 inline-block mr-1 -mt-0.5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><rect x="1" y="3" width="15" height="13" rx="1"/><path d="M16 8h4l3 5v3h-7V8z"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg> Check Serviceability
            </button>
